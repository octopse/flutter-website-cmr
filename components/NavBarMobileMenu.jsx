...
function NavBarMobileMenu(){
    return(
        <div className='bg-[#33333350] h-full w-full absolute right-0 top-0 flex justify-end'>
            <div className='bg-white h-full w-4/5 py-6 px-8'>
                <div className='border-b-2 border-gray-100 flex justify-end pb-5'>
                ...
                <div className='flex flex-col gap-y-4 text-lg font-medium text-center pt-8'>
                ...
                <div className='w-full flex flex-col justify-center text-center mt-8 gap-y-2'>
