...
function ArticlesCard({title, image}){
    return(
        <div className="group p-4 w-full h-full bg-no-repeat bg-left-top bg-cover rounded-xl relative overflow-hidden" style={{backgroundImage: `url(${image.src})`}}>
            ...
            <div className="h-[200px] w-full bg-white p-4 rounded-xl space-y-2 border-2 border-gray-300 absolute left-0 bottom-0 translate-y-52 group-hover:translate-y-0">
